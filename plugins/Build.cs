...
{
    [Info("Build", "Reneb & NoGrod", "1.2.8", ResourceId = 715)]
    class Build : RustPlugin
    {
        ...
        private void InitializeResources()
        {
            ...
            var filesField = typeof(FileSystem_AssetBundles).GetField("files", BindingFlags.Instance | BindingFlags.Public);
        ...
        private void InitializeSockets()
        {
            ...
            nameToSockets.Add("assets/prefabs/building core/foundation.steps/foundation.steps.prefab", SocketType.Wall);
        }
        ...
        private static void SpawnStructure(string prefabname, Vector3 pos, Quaternion angles, BuildingGrade.Enum grade, float health, uint buildingID = 0)
        {
        ...
        private static void DoBuild(BuildPlayer buildplayer, BasePlayer player, Collider baseentity)
        {
            ...
            SpawnStructure(buildplayer.currentPrefab, newPos, newRot, buildplayer.currentGrade, buildplayer.currentHealth, fbuildingblock.buildingID);
        }
